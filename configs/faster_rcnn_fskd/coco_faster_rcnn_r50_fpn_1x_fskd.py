...
# Distillation Params
teacher_config_path = 'result/coco/faster_rcnn_r50_fpn_1x/coco_faster_rcnn_r50_fpn_1x.py'
teacher_weight_path = 'result/coco/faster_rcnn_r50_fpn_1x/epoch_12.pth'
