...
# Distillation Params
teacher_config_path = 'result/coco/mcdet/teacher/faster_rcnn_r50_fpn_1x_crop0.9/coco_faster_rcnn_r50_fpn_1x_crop0.9.py'
teacher_weight_path = 'result/coco/mcdet/teacher/faster_rcnn_r50_fpn_1x_crop0.9/epoch_12.pth'
