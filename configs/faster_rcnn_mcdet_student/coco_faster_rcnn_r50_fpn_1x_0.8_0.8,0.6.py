...
# Distillation Params
teacher_config_path = 'result/coco/mcdet/teacher/faster_rcnn_r50_fpn_1x_crop0.8/coco_faster_rcnn_r50_fpn_1x_crop0.8.py'
teacher_weight_path = 'result/coco/mcdet/teacher/faster_rcnn_r50_fpn_1x_crop0.8/epoch_12.pth'
