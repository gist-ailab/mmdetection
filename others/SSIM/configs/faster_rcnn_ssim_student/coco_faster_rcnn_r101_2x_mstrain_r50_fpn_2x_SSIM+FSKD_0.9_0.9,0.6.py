...
# model
model = dict(type='FasterRCNN_TS_SSIM_SCALE',
             distill_name='SSIM+F_SKD',
             distill_param=1.5,
...
# Distillation Params
teacher_config_path = 'result/coco/mcdet/teacher/faster_rcnn_r101_fpn_2x_crop0.9_mstrain/coco_faster_rcnn_r101_fpn_2x_crop0.9_mstrain.py'
teacher_weight_path = 'result/coco/mcdet/teacher/faster_rcnn_r101_fpn_2x_crop0.9_mstrain/epoch_24.pth'
