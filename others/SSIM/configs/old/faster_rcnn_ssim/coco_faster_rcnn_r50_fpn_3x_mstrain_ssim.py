...
# Distillation Params
teacher_config_path = 'result/coco/faster_rcnn_r50_fpn_3x_mstrain/coco_faster_rcnn_r50_fpn_3x_mstrain.py'
teacher_weight_path = 'result/coco/faster_rcnn_r50_fpn_3x_mstrain/epoch_12.pth'
